...
for ro = 1: rows
    ...
    derivative(ro) = ((sum_plus(ro)/(2*liczba_kolumn)) - (sum_minus(ro)/(2*liczba_kolumn)))/(2*epsilon) ;
end
NumdJ = derivative;
end